...
describe('usePatientResourceListScreen', () => {
  ...
  it('supports patient-allergies list and create without route patient context', () => {
    usePatient.mockReturnValue({
      list: mockListPatients,
      data: {
        items: [
    ...
    const { result } = renderHook(() => usePatientResourceListScreen('patient-allergies'));
    ...
    expect(subtitle).toContain('patients.resources.patientAllergies.detail.severityLabel');
    expect(subtitle).toContain('SEVERE');
  ...
  it('supports consents list and create without route patient context', () => {
    usePatient.mockReturnValue({
      list: mockListPatients,
      data: {
        items: [
    ...
    const { result } = renderHook(() => usePatientResourceListScreen('consents'));
    ...
    expect(subtitle).toContain('patients.resources.consents.detail.statusLabel');

...
const usePatientAccess = () => {
  ...
  const canAccessPatients = canManageAllTenants || hasAnyRole(roleSet, PATIENT_ACCESS_ROLES);
  const canManagePatientRecords = canManageAllTenants || hasAnyRole(roleSet, PATIENT_WRITE_ROLES);
  const canDeletePatientRecords = canManageAllTenants || hasAnyRole(roleSet, PATIENT_DELETE_ROLES);

/**
 * HomeScreen Component - iOS
 * Authenticated home screen for iOS platform
 * File: HomeScreen.ios.jsx
 */
...
/**
 * HomeScreen component for iOS
 * @param {Object} props - HomeScreen props
 */
const HomeScreenIOS = (props) => {
  const { t } = useI18n();
  const {} = useHomeScreen();

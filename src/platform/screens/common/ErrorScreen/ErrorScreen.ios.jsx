/**
 * ErrorScreen Component - iOS
 * Generic error screen for iOS platform
 * File: ErrorScreen.ios.jsx
 */
 ...
 */
const ErrorScreenIOS = ({ onRetry, ...rest }) => {
  const { t } = useI18n();

...
import {
  ...
  StyledForm,
  StyledStatus,
} from './VerifyPhoneScreen.web.styles';

const VerifyPhoneScreenWeb = () => {
  const { t } = useI18n();
  const {
    form,
    errors,
  ...
  return (
    <StyledContainer role="region" aria-label={t('auth.verifyPhone.title')}>
      <StyledForm
        onSubmit={(event) => {
...
export default VerifyPhoneScreenWeb;

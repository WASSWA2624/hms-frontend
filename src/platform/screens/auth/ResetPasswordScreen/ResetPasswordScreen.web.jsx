...
import {
  ...
  StyledForm,
  StyledStatus,
} from './ResetPasswordScreen.web.styles';
...
const ResetPasswordScreenWeb = () => {
  ...
  return (
    <StyledContainer role="region" aria-label={t('auth.resetPassword.title')}>
      <StyledForm
        onSubmit={(event) => {
...
export default ResetPasswordScreenWeb;

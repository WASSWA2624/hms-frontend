...
const StyledContainer = styled.section.withConfig({
  ...
  componentId: 'ResetPasswordScreen_StyledContainer',
})`
  width: 100%;
...
const StyledForm = styled.form.withConfig({
  ...
  componentId: 'ResetPasswordScreen_StyledForm',
})`
  width: 100%;
  display: flex;
  flex-direction: column;
...
const StyledField = styled.div.withConfig({
  ...
  componentId: 'ResetPasswordScreen_StyledField',
})`
  width: 100%;
`;
...
const StyledActions = styled.div.withConfig({
  ...
  componentId: 'ResetPasswordScreen_StyledActions',
})`
  display: flex;
  flex-direction: column;
...
const StyledStatus = styled.div.withConfig({
  ...
  componentId: 'ResetPasswordScreen_StyledStatus',
})`
  margin-top: ${({ theme }) => theme.spacing.xs}px;
`;

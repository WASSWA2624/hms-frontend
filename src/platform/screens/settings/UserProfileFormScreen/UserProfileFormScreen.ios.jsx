...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './UserProfileFormScreen.ios.styles';
import useUserProfileFormScreen from './useUserProfileFormScreen';

const UserProfileFormScreenIOS = () => {
  const { t } = useI18n();
  const {
    isEdit,
    userId,
...
export default UserProfileFormScreenIOS;

...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './UserRoleFormScreen.web.styles';
import useUserRoleFormScreen from './useUserRoleFormScreen';

const UserRoleFormScreenWeb = () => {
  const { t } = useI18n();
  const {
    isEdit,
    tenantId,
  ...
  if (isEdit && !userRole && isLoading) {
    return (
      <StyledContainer role="main" aria-label={t('userRole.form.editTitle')}>
        <StyledContent>
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('userRole.form.editTitle') : t('userRole.form.createTitle')}>
      <StyledContent>
          ...
          <StyledFormGrid>
            <StyledFullRow>
              <StyledFieldGroup>
                {tenantListLoading ? (
                  ...
                  <StyledHelperStack
                    role="region"
                    aria-label={t('userRole.form.tenantLabel')}
                    data-testid="user-role-form-no-tenants"
                  >
            ...
            <StyledFieldGroup>
              {userListLoading ? (
                ...
                <StyledHelperStack
                  role="region"
                  aria-label={t('userRole.form.userLabel')}
                  data-testid="user-role-form-no-users"
                >
            ...
            <StyledFieldGroup>
              {roleListLoading ? (
                ...
                <StyledHelperStack
                  role="region"
                  aria-label={t('userRole.form.roleLabel')}
                  data-testid="user-role-form-no-roles"
                >
            ...
            <StyledFieldGroup>
              {facilityListLoading ? (
                ...
                <StyledHelperStack
                  role="region"
                  aria-label={t('userRole.form.facilityLabel')}
                  data-testid="user-role-form-no-facilities"
                >
...
export default UserRoleFormScreenWeb;

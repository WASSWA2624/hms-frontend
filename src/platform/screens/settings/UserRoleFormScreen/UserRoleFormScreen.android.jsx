...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './UserRoleFormScreen.android.styles';
import useUserRoleFormScreen from './useUserRoleFormScreen';

const UserRoleFormScreenAndroid = () => {
  const { t } = useI18n();
  const {
    isEdit,
    userId,
...
export default UserRoleFormScreenAndroid;

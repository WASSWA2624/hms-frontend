...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './ContactFormScreen.ios.styles';
import useContactFormScreen from './useContactFormScreen';

const ContactFormScreenIOS = () => {
  const { t } = useI18n();
  const {
    isEdit,
    value,
...
export default ContactFormScreenIOS;

...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './UnitFormScreen.web.styles';
...
const UnitFormScreenWeb = () => {
  ...
  if (isEdit && !unit && isLoading) {
    return (
      <StyledContainer role="main" aria-label={t('unit.form.editTitle')}>
        <StyledContent>
          ...
          <StyledFormGrid>
              ...
              <StyledFullRow>
                <StyledFieldGroup>
                  {tenantListLoading ? (
                    ...
                    <StyledHelperStack
                      role="region"
                      aria-label={t('unit.form.tenantLabel')}
                      data-testid="unit-form-no-tenants"
                    >
            ...
            <StyledFieldGroup>
              {facilityListLoading ? (
                ...
                <StyledHelperStack
                  role="region"
                  aria-label={t('unit.form.facilityLabel')}
                  data-testid="unit-form-no-facilities"
                >
            ...
            <StyledFieldGroup>
              {departmentListLoading ? (
                ...
                <StyledHelperStack
                  role="region"
                  aria-label={t('unit.form.departmentLabel')}
                  data-testid="unit-form-no-departments"
                >

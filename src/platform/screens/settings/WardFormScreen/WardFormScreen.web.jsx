...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './WardFormScreen.web.styles';
...
const WardFormScreenWeb = () => {
  ...
  if (isEdit && !ward && isLoading) {
    return (
      <StyledContainer role="main" aria-label={t('ward.form.editTitle')}>
        <StyledContent>
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('ward.form.editTitle') : t('ward.form.createTitle')}>
      <StyledContent>
              ...
              <StyledFullRow>
                <StyledFieldGroup>
                  {tenantListLoading ? (
                    ...
                    <StyledHelperStack
                      role="region"
                      aria-label={t('ward.form.tenantLabel')}
                      data-testid="ward-form-no-tenants"
                    >
              ...
              <StyledFullRow>
                <StyledFieldGroup>
                  {facilityListLoading ? (
                    ...
                    <StyledHelperStack
                      role="region"
                      aria-label={t('ward.form.facilityLabel')}
                      data-testid="ward-form-no-facilities"
                    >

...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './ApiKeyPermissionFormScreen.web.styles';
...
const ApiKeyPermissionFormScreenWeb = () => {
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('apiKeyPermission.form.editTitle') : t('apiKeyPermission.form.createTitle')}>
      <StyledContent>
            ...
            <StyledFullRow>
              <StyledFieldGroup>
                {apiKeyListLoading ? (
                  ...
                  <StyledHelperStack role="region" aria-label={t('apiKeyPermission.form.apiKeyLabel')} data-testid="api-key-permission-form-no-api-keys">
            ...
            <StyledFullRow>
              <StyledFieldGroup>
                {permissionListLoading ? (
                  ...
                  <StyledHelperStack role="region" aria-label={t('apiKeyPermission.form.permissionLabel')} data-testid="api-key-permission-form-no-permissions">

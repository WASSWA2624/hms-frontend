/**
 * ApiKeyPermissionFormScreen - iOS
 */
...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './ApiKeyPermissionFormScreen.ios.styles';
import useApiKeyPermissionFormScreen from './useApiKeyPermissionFormScreen';

const ApiKeyPermissionFormScreenIOS = () => {
  const { t } = useI18n();
  const {
    isEdit,
    apiKeyId,
...
export default ApiKeyPermissionFormScreenIOS;

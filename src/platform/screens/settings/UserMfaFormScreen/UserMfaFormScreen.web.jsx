...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './UserMfaFormScreen.web.styles';
...
const UserMfaFormScreenWeb = () => {
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('userMfa.form.editTitle') : t('userMfa.form.createTitle')}>
      <StyledContent>
            ...
            <StyledFullRow>
              <StyledFieldGroup>
                {userListLoading ? (
                  ...
                  <StyledHelperStack role="region" aria-label={t('userMfa.form.userLabel')} data-testid="user-mfa-form-no-users">

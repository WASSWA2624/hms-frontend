...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './UserMfaFormScreen.ios.styles';
import useUserMfaFormScreen from './useUserMfaFormScreen';

const UserMfaFormScreenIOS = () => {
  const { t } = useI18n();
  const {
    isEdit,
    userId,
...
export default UserMfaFormScreenIOS;

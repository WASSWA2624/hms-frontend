/**
 * OauthAccountFormScreen - Android
 */
...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './OauthAccountFormScreen.android.styles';
import useOauthAccountFormScreen from './useOauthAccountFormScreen';

const OauthAccountFormScreenAndroid = () => {
  const { t } = useI18n();
  const {
    isEdit,
    userId,
...
export default OauthAccountFormScreenAndroid;

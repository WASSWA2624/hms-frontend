...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './OauthAccountFormScreen.web.styles';
import useOauthAccountFormScreen from './useOauthAccountFormScreen';

const OauthAccountFormScreenWeb = () => {
  const { t } = useI18n();
  const {
    isEdit,
    userId,
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('oauthAccount.form.editTitle') : t('oauthAccount.form.createTitle')}>
      <StyledContent>
            ...
            <StyledFullRow>
              <StyledFieldGroup>
                {userListLoading ? (
                  ...
                  <StyledHelperStack role="region" aria-label={t('oauthAccount.form.userLabel')} data-testid="oauth-account-form-no-users">
...
export default OauthAccountFormScreenWeb;

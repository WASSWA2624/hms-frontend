...
const StyledInlineStates = styled.div.withConfig({
  displayName: 'ApiKeyFormScreen_StyledInlineStates',
  componentId: 'ApiKeyFormScreen_StyledInlineStates',
})`
  display: flex;
  flex-direction: column;
...
const StyledFormGrid = styled.div.withConfig({
  displayName: 'ApiKeyFormScreen_StyledFormGrid',
  componentId: 'ApiKeyFormScreen_StyledFormGrid',
})`
  display: grid;
...
const StyledFieldGroup = styled.div.withConfig({
  displayName: 'ApiKeyFormScreen_StyledFieldGroup',
  componentId: 'ApiKeyFormScreen_StyledFieldGroup',
})`
  display: flex;
  flex-direction: column;
...
const StyledFullRow = styled.div.withConfig({
  displayName: 'ApiKeyFormScreen_StyledFullRow',
  componentId: 'ApiKeyFormScreen_StyledFullRow',
})`
  grid-column: 1 / -1;
`;

const StyledHelperStack = styled.div.withConfig({
  displayName: 'ApiKeyFormScreen_StyledHelperStack',
  componentId: 'ApiKeyFormScreen_StyledHelperStack',
})`
  display: flex;
  flex-direction: column;
  gap: ${({ theme }) => theme.spacing.sm}px;

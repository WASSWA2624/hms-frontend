...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './ApiKeyFormScreen.web.styles';
import useApiKeyFormScreen from './useApiKeyFormScreen';

const ApiKeyFormScreenWeb = () => {
  const { t } = useI18n();
  const {
    isEdit,
    tenantId,
  ...
  if (isEdit && !apiKey && isLoading) {
    return (
      <StyledContainer role="main" aria-label={t('apiKey.form.editTitle')}>
        <StyledContent>
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('apiKey.form.editTitle') : t('apiKey.form.createTitle')}>
      <StyledContent>
              ...
              <StyledFullRow>
                <StyledFieldGroup>
                  {tenantListLoading ? (
                    ...
                    <StyledHelperStack role="region" aria-label={t('apiKey.form.tenantLabel')} data-testid="api-key-form-no-tenants">
              ...
              <StyledFullRow>
                <StyledFieldGroup>
                  {userListLoading ? (
                    ...
                    <StyledHelperStack role="region" aria-label={t('apiKey.form.userLabel')} data-testid="api-key-form-no-users">
...
export default ApiKeyFormScreenWeb;

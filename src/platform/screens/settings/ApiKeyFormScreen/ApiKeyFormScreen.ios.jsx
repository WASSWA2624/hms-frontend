...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './ApiKeyFormScreen.ios.styles';
import useApiKeyFormScreen from './useApiKeyFormScreen';

const ApiKeyFormScreenIOS = () => {
  const { t } = useI18n();
  const {
    isEdit,
    tenantId,
...
export default ApiKeyFormScreenIOS;

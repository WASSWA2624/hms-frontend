/**
 * TenantDetailScreen - iOS
 * File: TenantDetailScreen.ios.jsx
 */
...
import {
  ...
  StyledInlineStates,
  StyledActions,
} from './TenantDetailScreen.ios.styles';
import useTenantDetailScreen from './useTenantDetailScreen';

const TenantDetailScreenIOS = () => {
...
export default TenantDetailScreenIOS;

...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './AddressFormScreen.android.styles';
import useAddressFormScreen from './useAddressFormScreen';

const AddressFormScreenAndroid = () => {
  const { t } = useI18n();
  const {
    isEdit,
    addressType,
...
export default AddressFormScreenAndroid;

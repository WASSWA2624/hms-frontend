...
import {
  ...
  StyledInlineStates,
  StyledActions,
} from './BedDetailScreen.web.styles';
...
const BedDetailScreenWeb = () => {
  ...
  if (isLoading && !hasBed) {
    return (
      <StyledContainer role="main" aria-label={t('bed.detail.title')}>
        <StyledContent>
          <LoadingSpinner
...
export default BedDetailScreenWeb;

...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './RolePermissionFormScreen.web.styles';
import useRolePermissionFormScreen from './useRolePermissionFormScreen';

const RolePermissionFormScreenWeb = () => {
  const { t } = useI18n();
  const {
    isEdit,
    roleId,
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('rolePermission.form.editTitle') : t('rolePermission.form.createTitle')}>
      <StyledContent>
            ...
            <StyledFullRow>
              <StyledFieldGroup>
                {roleListLoading ? (
                  ...
                  <StyledHelperStack role="region" aria-label={t('rolePermission.form.roleLabel')} data-testid="role-permission-form-no-roles">
            ...
            <StyledFullRow>
              <StyledFieldGroup>
                {permissionListLoading ? (
                  ...
                  <StyledHelperStack role="region" aria-label={t('rolePermission.form.permissionLabel')} data-testid="role-permission-form-no-permissions">
...
export default RolePermissionFormScreenWeb;

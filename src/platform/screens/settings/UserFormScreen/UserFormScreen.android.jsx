...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './UserFormScreen.android.styles';
import useUserFormScreen from './useUserFormScreen';

const UserFormScreenAndroid = () => {
  const { t } = useI18n();
  const {
    isEdit,
    tenantId,
...
export default UserFormScreenAndroid;

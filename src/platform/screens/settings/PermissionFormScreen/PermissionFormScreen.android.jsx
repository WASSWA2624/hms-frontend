...
import { StyledContainer, StyledContent, StyledSection, StyledActions } from './PermissionFormScreen.android.styles';
import usePermissionFormScreen from './usePermissionFormScreen';

const PermissionFormScreenAndroid = () => {
  const { t } = useI18n();
  const {
    isEdit,
    tenantId,
...
export default PermissionFormScreenAndroid;

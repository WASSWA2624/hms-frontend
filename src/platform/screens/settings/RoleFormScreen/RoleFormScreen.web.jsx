...
import {
  ...
  StyledHelperStack,
  StyledInlineStates,
} from './RoleFormScreen.web.styles';
...
const RoleFormScreenWeb = () => {
  ...
  if (isEdit && !role && isLoading) {
    return (
      <StyledContainer role="main" aria-label={t('role.form.editTitle')}>
        <StyledContent>
  ...
  return (
    <StyledContainer role="main" aria-label={isEdit ? t('role.form.editTitle') : t('role.form.createTitle')}>
      <StyledContent>
              ...
              <StyledFullRow>
                <StyledFieldGroup>
                  {tenantListLoading ? (
                    ...
                    <StyledHelperStack
                      role="region"
                      aria-label={t('role.form.tenantLabel')}
                      data-testid="role-form-no-tenants"
                    >
            ...
            <StyledFullRow>
              <StyledFieldGroup>
                {facilityListLoading ? (
                  ...
                  <StyledHelperStack
                    role="region"
                    aria-label={t('role.form.facilityLabel')}
                    data-testid="role-form-no-facilities"
                  >

...
const StyledInlineStates = styled.View.withConfig({
  displayName: 'RoleFormScreen_StyledInlineStates',
  componentId: 'RoleFormScreen_StyledInlineStates',
})`
...
const StyledFormGrid = styled.View.withConfig({
  displayName: 'RoleFormScreen_StyledFormGrid',
  componentId: 'RoleFormScreen_StyledFormGrid',
})`
  flex-direction: column;
  gap: ${({ theme }) => theme.spacing.md}px;
`;
...
const StyledFieldGroup = styled.View.withConfig({
  displayName: 'RoleFormScreen_StyledFieldGroup',
  componentId: 'RoleFormScreen_StyledFieldGroup',
})`
  flex-direction: column;
...
const StyledFullRow = styled.View.withConfig({
  displayName: 'RoleFormScreen_StyledFullRow',
  componentId: 'RoleFormScreen_StyledFullRow',
})``;

const StyledHelperStack = styled.View.withConfig({
  displayName: 'RoleFormScreen_StyledHelperStack',
  componentId: 'RoleFormScreen_StyledHelperStack',
})`
  flex-direction: column;
  gap: ${({ theme }) => theme.spacing.sm}px;
`;

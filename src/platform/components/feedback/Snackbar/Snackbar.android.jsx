/**
 * Snackbar Component - Android
 * Actionable notifications with action button
 * File: Snackbar.android.jsx
 */

import React from 'react';
import { StyledSnackbar, StyledSnackbarText, StyledActionButton, StyledActionButtonText } from './Snackbar.android.styles';
import { useI18n } from '@hooks';
import { VARIANTS, POSITIONS } from './types';

/**
 * Snackbar component for Android
...
export default SnackbarAndroid;

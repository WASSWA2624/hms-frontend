/**
 * TabBar Component Styles - Android
 * Styled-components for TabBar Android implementation
 * File: TabBar.android.styles.jsx
 */
...
const StyledTabBar = styled(View).withConfig({
  ...
  elevation: ${({ theme }) => theme?.shadows?.md?.elevation || 4};
`;

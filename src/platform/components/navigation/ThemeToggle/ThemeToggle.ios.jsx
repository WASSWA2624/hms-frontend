...
import { StyledThemeToggleWrapper, StyledThemeToggleTrack, StyledThemeToggleButton } from './ThemeToggle.ios.styles';

const ThemeToggleIOS = ({ testID, accessibilityLabel }) => {
  const { t } = useI18n();

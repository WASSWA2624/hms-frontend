/**
 * EmptyState Component - Android
 * Empty state display with icon, title, description, and optional action
 * File: EmptyState.android.jsx
 */

import React from 'react';
import { StyledEmptyState, StyledIconContainer, StyledTitle, StyledDescription, StyledActionContainer } from './EmptyState.android.styles';
import { useEmptyState } from './useEmptyState';
import { useI18n } from '@hooks';
import { SIZES } from './types';

/**
 * EmptyState component for Android

...
export default function BillingPricingRulesCreateRoute() {
  const { t } = useI18n();
  ...
  return (
    <Card
      ...
      testID="billing-pricing-rules-create-unavailable"
    >
      <Text variant="h3" accessibilityRole="header">
        {t('billing.unavailable.pricingRules.createBlockedTitle')}
      </Text>
      <Text variant="body">{t('billing.unavailable.pricingRules.createBlockedDescription')}</Text>
      <Button
        variant="surface"
        size="small"

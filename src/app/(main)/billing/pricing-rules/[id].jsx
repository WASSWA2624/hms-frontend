...
export default function BillingPricingRulesDetailRoute() {
  const { t } = useI18n();
  ...
  return (
    <Card
      ...
      testID="billing-pricing-rules-detail-unavailable"
    >
      <Text variant="h3" accessibilityRole="header">
        {t('billing.unavailable.pricingRules.detailBlockedTitle')}
      </Text>
      <Text variant="body">{t('billing.unavailable.pricingRules.detailBlockedDescription')}</Text>
      <Button
        variant="surface"
        size="small"

...
export default function BillingCoveragePlansDetailRoute() {
  const { t } = useI18n();
  ...
  return (
    <Card
      ...
      testID="billing-coverage-plans-detail-unavailable"
    >
      <Text variant="h3" accessibilityRole="header">
        {t('billing.unavailable.coveragePlans.detailBlockedTitle')}
      </Text>
      <Text variant="body">{t('billing.unavailable.coveragePlans.detailBlockedDescription')}</Text>
      <Button
        variant="surface"
        size="small"

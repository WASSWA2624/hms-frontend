...
export default function BillingCoveragePlansEditRoute() {
  const { t } = useI18n();
  ...
  return (
    <Card
      ...
      testID="billing-coverage-plans-edit-unavailable"
    >
      <Text variant="h3" accessibilityRole="header">
        {t('billing.unavailable.coveragePlans.editBlockedTitle')}
      </Text>
      <Text variant="body">{t('billing.unavailable.coveragePlans.editBlockedDescription')}</Text>
      <Button
        variant="surface"
        size="small"
